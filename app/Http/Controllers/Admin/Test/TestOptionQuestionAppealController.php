...
class TestOptionQuestionAppealController extends Controller
{
    public function index(Request $request)
    {
        ...
        $appeals = TestOptionQuestionAppeal::with('question:id,text', 'test.subject','test.option', 'user:id,full_name')
        ...
        return Inertia::render('Admin/Test/OptionQuestionAppeals/Index', [
            'appeals' => $appeals,
    ...
    {
        $appeal = TestOptionQuestionAppeal::findOrFail($id);
        $appeal->delete();
