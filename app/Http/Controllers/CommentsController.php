...
//        dd($request);
        ...
        if ($request->ajax()) {
            foreach ($coms as $com) {
                ...
                $data .= '<div class="cm_block"><div class="cm_avatar" style="background-image: url(/storage/images/avatars/'.$com->user->avatar.')"></div><div class="cm_content"><div class="cm_head">'.$com->user->full_name.'</div><div class="cm_body">'.$com->text.'</div><div class="cm_footer"><button type="button" class="btn cm_likes';
    ...
    function another($id){
        ...
        if ($request->ajax()) {
            foreach ($coms as $com) {
                $data .= '<div class="cm_block mini"><div class="cm_avatar" style="background-image: url(/storage/images/avatars/'.$com->user->avatar.')"></div><div class="cm_content"><div class="cm_head">'.$com->user->full_name.'</div><div class="cm_body">'.$com->text.'</div></div></div>';
            }
            return $data;
        }
    }
