...
class SalaryCalculator extends Model
{
    ...
    var WORK_IN_ENVIRONMENTAL_DISASTER_ZONES = [
    ...
    var WORK_IN_RADIATION_RISK_ZONES = [
        [
            'number' => 1,
            'name' => __('site.Нет'),
            'mrp' => 0
