<div class="modal fade" id="successPhonePopup" tabindex="-1" role="dialog" aria-labelledby="comingSoonPopup" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content inner-modal min-height-auto">
            <div class="modal-header modal-header-auth-padding">
                <h2 class="modal-title" style="color: #03B113">Номеріңіз сәтті өзгертілді</h2>
