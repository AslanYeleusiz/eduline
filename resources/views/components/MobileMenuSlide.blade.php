<div class="parent-mb_menu-slide">
    <div class="mb_menu-slide cst_pd">
        <div class="mb_header-slide">
            <a href="http://127.0.0.1:8000">
                <img class="mb_header-logo-img" src="http://127.0.0.1:8000/images/menu-icons/logo-icon.svg" alt="eduline.kz">
            </a>
        ...
        <div class="body">
                ...
                <li class="menu-li">
                    <a class="menu-link " onclick="openLogin()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="img-svg replaced-svg">
                            <path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" stroke="#3E6CED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M20.59 22C20.59 18.13 16.74 15 12 15C7.26003 15 3.41003 18.13 3.41003 22" stroke="#3E6CED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                        Кіру / Тіркелу                </a>
                </li>
            ...
            <ul class="menu-ul">
                ...
                <li class="menu-li">
                    <a class="menu-link " href="http://127.0.0.1:8000/attestation">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="img-svg replaced-svg">
                ...
                <li class="menu-li">
                    <a class="menu-link " href="http://127.0.0.1:8000/calculator">
                ...
                <li class="menu-li">
                    <a class="menu-link " href="http://127.0.0.1:8000/consultations">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="img-svg replaced-svg">
                ...
                <li class="menu-li">
                    <a class="menu-link " href="http://127.0.0.1:8000/materials">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="img-svg replaced-svg">
            ...
            <div class="dropdown show">
                <a class="tilder dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="http://127.0.0.1:8000/images/kz.svg"> ҚАЗ
                </a>
                <div class="dropdown-menu tilder-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item tilder-item" href="http://127.0.0.1:8000/set_locale/kk">
                        <img src="http://127.0.0.1:8000/images/kz.svg"> ҚАЗ
                    </a>
                    <a class="dropdown-item tilder-item" href="http://127.0.0.1:8000/set_locale/ru">
                        <img src="http://127.0.0.1:8000/images/ru.svg"> РУС
                    </a>
                </div>
            </div>
        </div>
