<div class="modal fade" id="subscriptionPayPopup" tabindex="-1" role="dialog" aria-labelledby="subscriptionPayPopup"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content inner-modal min-height-auto modal-content-second">
