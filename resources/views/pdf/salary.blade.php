...
<body class="page-break" style="padding:20px;">
    ...
    <table style="border-collapse: collapse; width: 100%" cellspacing="0">
        <tr style="height: 18pt">
            <td class="table-tr-2-column-key">
                <p class="s2 s2-table-col-key">
    ...
    <table style="border-collapse: collapse; ; width: 100%" cellspacing="0">
        ...
        <tr style="height: 18pt">
            ...
            <td class="s2-table-col-center">
                <p class="s2 s2-table-col-center-text-2">
                    @lang('site.'.Arr::last(\App\Models\SalaryCalculator::PED_SKILLS, function ($value, $key) use ($data) {
       return $value['number'] ==  $data['base']['ped_skill'];
        ...
        <tr style="height: 31pt">
            <td class="s2-td-key">
                <p class="s2 s2-td-key-text-2">
                    @lang('site.Доплата за работу в зоне экологического бедствия')
                </p>
            </td>
            <td class="s2-table-col-center">
                <p class="s2 s2-table-col-center-text-2">
                    @lang('site.'.Arr::last(\App\Models\SalaryCalculator::WORK_IN_ENVIRONMENTAL_DISASTER_ZONES, function ($value, $key) use ($data) {
      return $value['number'] ==  $data['base']['work_in_env_disaster_zone'];
        ...
        <tr style="height: 31pt">
            ...
            <td class="s2-table-col-center">
                <p class="s2 s2-table-col-center-text-2">
                    @lang('site.'.Arr::last(\App\Models\SalaryCalculator::WORK_IN_RADIATION_RISK_ZONES, function ($value, $key) use ($data) {
        ...
        <tr style="height: 31pt">
            ...
            <td class="s2-table-col-center">
                <p class="s2 s2-table-col-center-text-2">
                    @lang('site.'.Arr::last(\App\Models\SalaryCalculator::TECHING_IN_ENGLISH_ITEMS, function ($value, $key) use ($data) {
        ...
        <tr style="height: 31pt">
            ...
            <td class="s2-table-col-center">
                <p class="s2 s2-table-col-center-text-2">
                    @lang('site.Учитель начальных классов') {{ $data['base']['for_checking_notebooks_half_classes'] }} @lang('site.часов')
                </p>
            </td>
            <td class="table-td-2-column-val">
                <p class="s2 s2-table-col-val-text">
        ...
        <tr style="height: 31pt">
            ...
            <td class="s2-table-col-center">
                <p class="s2 s2-table-col-center-text-2">
                    @lang('site.Учитель начальных классов') {{ $data['base']['for_checking_notebooks_full_classes'] }} @lang('site.часов')
                </p>
            </td>
            <td class="table-td-2-column-val">
                <p class="s2 s2-table-col-val-text">
    ...
    <table style="border-collapse: collapse; ; width: 100%" cellspacing="0">
        <tr style="height: 18pt">
            <td class="table-tr-2-column-key" style="border-top: unset !important;">
                <p class="s2 s2-table-col-key">
                    @lang('site.ИТОГО НАЧИСЛЕНО'):
                </p>
            </td>
            <td class="table-td-2-column-val" style="border-top: unset !important;">
                <p class="s2 s2-table-col-val">
                    {{ $data['total_accured'] }}
                </p>
            </td>
