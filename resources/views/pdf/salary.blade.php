...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru">
  ...
  <body>
    ...
    >
      ...
      <br>
      Стаж: 10 лет 0 месяцев 0 дней
    </p>
    <p style="padding-left: 24pt; text-indent: 0pt; text-align: left">
      Количество ставок: 0.94
    </p>
    <p style="text-indent: 0pt; text-align: left"><br /></p>
    ...
    <p style="text-indent: 0pt; text-align: left"><br /></p>
    <table
      style="border-collapse: collapse; margin-left: 6.27pt"
      cellspacing="0"
    >
    ...
    >
      ...
      <tr style="height: 31pt">
        ...
        <td class="s2-table-col-center">
            <p class="s2 s2-table-col-center-text-2">
                Зона черезвычайного радиационнного риска
          </p>
        </td>
        <td class="table-td-2-column-val">
            <p class="s2 s2-table-col-val-text" >
    ...
    >
      ...
      <tr style="height: 31pt">
        ...
        <td class="s2-table-col-center">
            <p class="s2 s2-table-col-center-text-2">
                Учитель начальных классов 5 часов
          </p>
        </td>
        <td class="table-td-2-column-val">
            <p class="s2 s2-table-col-val-text" >
      ...
      <tr style="height: 31pt">
        ...
        <td class="s2-table-col-center">
            <p class="s2 s2-table-col-center-text-2">
                Учитель начальных классов 10 часов
          </p>
        </td>
        <td class="table-td-2-column-val">
            <p class="s2 s2-table-col-val-text" >
