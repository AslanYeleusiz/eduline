    ...
    <section class="kenes">
        <div class="cst_pd">
            ...
            <div class="add_info k_add_info">
                Сабақ онлайн немесе офлайн форматта тренермен жалғыз өзіңіз отырып үйреніп шығасыз. Сабақтың соңында
                сізге үлгілері мен стандарттарды және қалай толтыру керектігі туралы толық нұсқаулықты береді.
            </div>
        </div>
        <div class="k_form_block">
            <div class="cst_pd">
                ...
                <form method="post" action="{{url('kenes/send')}}" class="k_form needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <input type="text" class="form-control k_cst_inp" placeholder="Аты-жөніңіз" id="name"
                                   name="name" required>
                        </div>
                        <div class="col-md">
                            <input type="text" class="form-control k_cst_inp phone_mask" placeholder="Телефон номеріңіз"
            ...
            <div class="cst_com_slider owl-carousel com_cst_pd">
                <div class="com_block">
                    <div class="com_head">
                        ...
                        <div class="com_body">
                            Нұржамал ханымнан консультация алып, бір ай аралығында авторлық бағларламамды қорғап шықтым.
                            Қазір педагог шебер болдым. Сіздерге үлкен рақмет. Бұрын қиын деп жүрген көп жұмыстарымды
        ...
        <div class="cns_free_block">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <p>
                        Программаны телефонға орнатудан түсінбесеңіз немесе біздің орталық туралы сұрақтарыңыз болса
                        бізге хабарласыңыз, біздің менеджерлер сізге түсіндіріп береді
                    </p>
                </div>
                <div class="col-md-1">
                    <div class="vl"></div>
                ...
                <div class="col-md-4">
                    ...
                    <a href="#">
                        <button class="btn chat-btn">Чатқа қосылу</button>
                    </a>
                </div>
            </div>
        </div>
