...
@section('content')
            ...
            <div class="popup_main">
                ...
                <form action="" class="needs-validation">
                    <textarea class="form-control" id="exampleFormControlTextarea1"
                              placeholder="Материалды жоямын деп шешкен себебім..." required></textarea>
    ...
    <div id="popup2" class="my_popup">
        <div class="popup_body">
            ...
            <div class="popup_main">
                ...
                <div class="takyryb">
                    ...
                    <div class="tak_name">Автор: Сембиев Нартай Амангалиулы<br><span class="mekeni">Павлодар облысы Ақсу қаласы №16 сәбилер бақшасы тәрбиешісі</span>
                    </div>
                </div>
        ...
        <div class="send_block my_send_block">
            <div class="esc_btn"><img class="my_esc_icon" src="{{asset('images/escape.png')}}"></div>
            <div class="success_message"> Сіздің сұранысыңыз сәтті қабылданды. Сайт әкімшілігі тексерген соң сізге
                хабарласады
            </div>
        </div>
    </div>
            ...
            <div class="m_content">
                <div class="m_block my_m_block">
                    <div class="my_m_block_h">
                        ...
                        <div class="my_edit">
                            <a href="/materials/my-materials/change" class="editBtn"><img
                                    src="{{asset('images/edit-2.png')}}"><span>Өзгерту</span></a>
                            <button class="btn deleteBtn pupup1"><img
                                    src="{{asset('images/trash.png')}}"><span>Жою</span></button>
                        </div>
                    </div>
                    <div class="my_m_block_b">
                        ...
                        <div id="m_body" class="m_body">
                            Түркістан облысы Бәйдібек ауданының адами әлеуетті дамыту бөліміне қарасты "С.Ерубаев
                            атындағы жалпы орта мектебі" коммуналдық мемлекеттік мекемесінің тәлімгері
                        </div>
