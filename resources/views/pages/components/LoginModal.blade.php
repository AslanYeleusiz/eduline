    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content inner-modal">
            ...
            <div class="modal-body">
                <form id="loginForm" class="modal-form" action="">
                    @csrf
                    <div class="form-input-block">
                        ...
                        <span class="invalid-feedback error-phone" role="alert" id="error-phone"></span>
                    </div>

                    <div class="form-input-block">
                        <i class="form-input-icon icon-eye" onclick="iconEye(this)"></i>
                        <label class="modal-form-label" for="password">Құпиясөз:</label>
