    ...
    <div class="m_block cm_main">
        <div class="cst_pd">
            <form action="{{route('index.comments.store')}}" class="cm_form ns_block comment_btn">
                @csrf
                <div class="img" style="background-image: url({{asset(Auth::user()->avatar)}})" alt=""></div>
