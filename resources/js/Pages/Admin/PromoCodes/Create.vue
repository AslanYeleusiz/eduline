<template>
    <head>
        <title>Админ панель | Промо код қосу</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Промо код қосу</h1>
                </div>
                <div class="col-sm-6">
