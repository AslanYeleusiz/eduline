<template>
    <head>
        <title>Админ панель | Жеке кеңесті өзгерту</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Жеке кеңес № {{ personalAdvice.id }}</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                ...
                                <label
                                    ...
                                    for="customSwitch1"
                                    >Скидка ({{ personalAdvice.is_discount ? 'Бар': 'Жоқ'}})</label
                                >
                            </div>
                            <validation-error :field="'is_discount'" />
                        </div>
                        
                        <div class="form-group" v-if="personalAdvice.is_discount">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                ...
                                <label
                                    class="custom-control-label"
                                    for="customSwitch2"
                                    >Белсенді ({{ personalAdvice.is_active ? 'Иә': 'Жоқ'}})</label
                                >
                            </div>
                            <validation-error :field="'is_discount'" />
                        </div>
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.put(
                route("admin.personalAdvice.update", this.personalAdvice.id),
                this.personalAdvice,
                {
