<template>
    ...
    <head>
        <title>Админ панель | Жаңалық қосу</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Жаңалық қосу</h1>
                </div>
                <div class="col-sm-6">
                ...
                <form method="post" @submit.prevent="submit">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="ml-2">
                                <div class="form-group">
                                    <label for="">KK</label>
                                    <div class="ml-2"></div>
                                    <input type="text" class="form-control" v-model="news.title.kk" name="title" placeholder="Тақырыбы" />
                                ...
                                <div class="form-group">
                                    <label for="">RU</label>
                                    <div class="ml-2"></div>
                                    <input type="text" class="form-control" v-model="news.title.ru" name="title" placeholder="Тақырыбы" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="ml-2">
                                <div class="form-group">
                                    ...
                                    <ckeditor :editor="editor" v-model="news.short_description.kk" :config="editorConfig"></ckeditor>

                                    <validation-error :field="'short_description.kk'" />
                                </div>
                                <div class="form-group">
                                    <label for="">RU</label>
                                    <ckeditor :editor="editor" v-model="news.short_description.ru" :config="editorConfig"></ckeditor>

                                    <validation-error :field="'short_description.ru'" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="ml-2">
                                <div class="form-group">
                                    <label for="">KK</label>
                                    <ckeditor :editor="editor" v-model="news.description.kk" :config="editorConfig"></ckeditor>
                                    <validation-error :field="'description.kk'" />
                                </div>
                                <div class="form-group">
                                    <label for="">RU</label>
                                    <ckeditor :editor="editor" v-model="news.description.ru" :config="editorConfig"></ckeditor>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="news.news_types_id" name="news_types_id" required>
                                <option :value="null">Бағытын таңдаңыз</option>
                                <option :value="newsType.id" v-for="newsType in newsTypes" :key="'newsType' + newsType.id">
                                    {{ newsType.name.kk }}
                                </option>
                            </select>
                        ...
                        <div class="form-group file-upload">
                            ...
                            <div class="ml-2">
                                <div class="ml-2">
                                    ...
                                    <br>
                                    <img v-if="news.image.kk && !image_kk.file" :src="route('index')  +'/storage/images/news/' +  news.image.kk" height="300" alt="image" style="padding-bottom: 10px" />
                                ...
                                <div class="ml-2">
                                    <label for="">RU</label>
                                    <br>
                                    <img v-if="news.image && news.image.ru && !image_ru.file" :src="route('index') +'/storage/images/news/'+ news.image.ru" height="300" alt="" style="padding-bottom: 10px" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="news.view" name="view" placeholder="Қаралым саны" />
