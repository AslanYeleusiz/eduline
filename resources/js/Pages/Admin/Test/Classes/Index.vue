<template>
    <head>
        <title>Админ панель | Сыныптар</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Сыныптар тізімі</h1>
                </div>
                <div class="col-sm-6">
        ...
        <template #header>
            <div class="buttons">
                <Link
                    ...
                    :href="route('admin.test.classes.create')"
                >
                ...
                <Link
                    ...
                    :href="route('admin.test.classes.index')"
                >
