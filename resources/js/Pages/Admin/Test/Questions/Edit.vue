                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr class="odd even">
                                    ...
                                    <td id="question">
                                        <ckeditor :editor="editor" v-model="question.text" :config="editorConfig" class="form-control" v-if="input_type === 'ckeditor'"></ckeditor>
                                ...
                                <tr v-for="(answer, index) in answers" :key="'answer' + index" class="odd even">
                                    <td>
                                        <b>{{
