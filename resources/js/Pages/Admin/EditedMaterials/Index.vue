<template>
    <head>
        <title>Админ панель | Өзгертілген материалдар</title>
    </head>
    <AdminLayout>
        <template #breadcrumbs>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Өзгертілген материалдар тізімі</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            Өзгертілген материалдар тізімі
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <template #header>
            <div class="buttons">
                <Link
                    ...
                    :href="route('admin.editedMaterials.index')"
                >
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        v-for="(
                                            material, index
                                        ) in editedMaterials.data"
                                        :key="'material' + material.id"
                                    >
                                        <td>
                                            {{
                                                editedMaterials.from
                                                    ? editedMaterials.from +
                                                      index
                                                    : index + 1
                                            }}
                    ...
                    <Pagination :links="editedMaterials.links" />
                </div>
            </div>
        </div>
    </AdminLayout>
...
export default {
    ...
    methods: {
        ...
        deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete(
                        route("admin.editedMaterials.destroy", id)
                    );
                }
            });
        },
        search() {
            ...
            this.$inertia.get(route("admin.editedMaterials.index"), params);
        },
    },
};
</script>
