...
Route::view('/public_offer_rus', 'offer_rus.public_offer_rus')->name('public_offer_rus');
Route::view('/privacy_policy_of_app', 'offer_rus.privacy_policy_of_app')->name('privacy_policy_of_app');
